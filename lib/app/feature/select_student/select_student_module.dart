...
import 'package:elesson/app/feature/select_student/page/select_student_page.dart';
...
import '../../../share/qr_code_reader.dart';
...
class SelectStudentModule extends StatefulWidget {
  final BlockModel? blockModelOffline;
  final OfflineController offlineController;
  const SelectStudentModule({super.key, this.blockModelOffline, required this.offlineController});

  @override
  State<SelectStudentModule> createState() => _SelectStudentModuleState();
}

class _SelectStudentModuleState extends State<SelectStudentModule> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: AnimatedBuilder(
          ...
          builder: (context, child) => SelectStudentPage(qrCodeController: _qrCodeController,offlineController: widget.offlineController , blockModelOffline: widget.blockModelOffline)
      ),
    );
  }
}
